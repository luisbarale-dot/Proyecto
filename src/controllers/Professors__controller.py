...
class Professor_Controller(): #Establezco un controller para
    def __init__(self): 
    ...
    def register_Professor(self, professor_data: dict) -> bool: #Hay que registrar al docente.
        try:
            ...
            professor = Professors( #Se instancia el objeto con los datos recibidos del diccionario.
                ...
                professor_data.get("second_name"),
                professor_data.get("last_name"),
                professor_data.get("second_last_name"),
            ...
            new_professor = {  #Creo un diccionario con los datos del docente.
                ...
                "Segundo Nombre": professor.second_name,
                "Primer Apellido": professor.last_name,
                "Segundo Apellido": professor.second_last_name,
